...
export const statsData = {
  en: [
    { id: 1, value: 1532, suffix: "+", label: "Party Members" },
    { id: 2, value: 25, suffix: "+", label: "Years of Service" },
    { id: 3, value: 1480, suffix: "+", label: "Successful Campaigns" },
    { id: 4, value: 28000, suffix: "k+", label: "Students" },
  ],
  ta: [
